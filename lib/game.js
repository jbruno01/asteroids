...
Game.prototype.renderGameOver = function () {
  ...
  ctx.fillText("Game Over!!", this.DIM_X / 2, this.DIM_Y / 2 - 100);
  ctx.fillText("Points: " + this.POINTS, this.DIM_X / 2, this.DIM_Y / 2);
  ctx.fillText("R to reset", this.DIM_X / 2, this.DIM_Y / 2 + 100);
...
Game.prototype.renderStartScreen = function () {
  ...
  ctx.font = "36px sans-serif";
  ctx.textAlign = "center";
  ctx.fillText("Arrows to move : Space to fire", this.DIM_X / 2, this.DIM_Y / 2 - 25);
  ctx.fillText("Press Enter to start", this.DIM_X / 2, this.DIM_Y / 2 + 25);
  key("enter", function () {
    this.started = true;
  }.bind(this))
}
